    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/sdk"
                className={`hidden sm:flex items-center gap-2 px-4 py-2 border-4 ${isDark ? "border-white/30 text-white/70 hover:border-white hover:text-white" : "border-black/30 text-black/70 hover:border-black hover:text-black"} font-black text-sm transition-all`}
              >
      ...
      <section className="pt-32 pb-12 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className={`text-xl max-w-2xl mb-8 ${isDark ? "text-white/60" : "text-black/60"}`}>
          ...
          <div className="flex gap-0 mb-8">
            {[
              ...
              { id: "live", label: "LIVE WALLET", icon: Wallet },
            ].map((tab) => (
              <button
                key={tab.id}
          ...
          {activeTab === "playground" && (
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className={`border-4 ${isDark ? "border-white" : "border-black"}`}>
                ...
                {/* Quick Examples */}
                <div className={`px-4 pb-4 border-t-4 ${isDark ? "border-white/20" : "border-black/20"} pt-4`}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      { label: "Send XLM", code: CODE_EXAMPLES.sendPayment },
              ...
              <div className={`border-4 ${isDark ? "border-white" : "border-black"}`}>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-black text-sm">CONSOLE_OUTPUT.LOG</span>
                  </div>
                  <button
                    onClick={() =>
                      setConsoleOutput(["// Stellar zkLogin SDK Demo Console", "// Ready to execute code..."])
                    }
                    className="text-xs font-black opacity-50 hover:opacity-100"
                  >
                    CLEAR
                  </button>
                </div>
                <div className={`p-4 h-[500px] overflow-y-auto font-mono text-sm ${isDark ? "bg-black" : "bg-gray-900"}`}>
                  ...
                  <div className={`p-4 border-t-4 ${isDark ? "border-white/20" : "border-black/20"}`}>
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-black text-sm text-[#00FF88]">CONNECTED</span>
                      </div>
                      <button
                        onClick={simulateDisconnect}
                        className={`text-xs font-black ${isDark ? "text-[#FF3366]" : "text-[#CC0033]"}`}
                      >
                        DISCONNECT
                      </button>
                    </div>
          ...
          {activeTab === "live" && (
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                <div className={`border-4 ${isDark ? "border-white" : "border-black"}`}>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-black text-sm">ZKLOGIN_WALLET.EXE</span>
                    </div>
                    {demoWallet && (
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-[#00FF88]" />
                        <span className="font-black text-xs text-[#00FF88]">CONNECTED</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-6 sm:p-8">
                    {!demoWallet ? (
                      <div className="text-center py-12">
                        <div
                          className={`w-24 h-24 mx-auto mb-6 border-4 border-dashed ${isDark ? "border-white/30" : "border-black/30"} flex items-center justify-center`}
                        >
                          <Wallet className={`w-12 h-12 ${isDark ? "text-white/30" : "text-black/30"}`} />
                        </div>
                        <h3 className="text-2xl font-black mb-4">CONNECT YOUR WALLET</h3>
                      ...
                      <>
                        ...
                        <div className="mb-8">
                          <div className="flex items-center justify-between mb-2">
                            <p className={`font-bold text-sm ${isDark ? "text-white/50" : "text-black/50"}`}>
                              TOTAL BALANCE
                            </p>
                          ...
                          <div className="flex items-baseline gap-4">
                            ...
                            <span className={`text-2xl font-black ${isDark ? "text-white/40" : "text-black/40"}`}>
                              XLM
                            </span>
                          </div>
                        </div>
                        ...
                        <div className={`p-4 border-4 ${isDark ? "border-white/20" : "border-black/20"} mb-6`}>
                          <p className={`font-bold text-xs mb-2 ${isDark ? "text-white/50" : "text-black/50"}`}>
                            WALLET ADDRESS
                          </p>
                          <div className="flex items-center gap-3">
                            <code
                        ...
                        {/* Send Form */}
                        <div className={`p-4 border-4 ${isDark ? "border-white/20" : "border-black/20"} mb-6`}>
                          <p className={`font-bold text-xs mb-4 ${isDark ? "text-white/50" : "text-black/50"}`}>
                            SEND XLM
                          </p>
                          <div className="grid sm:grid-cols-2 gap-4 mb-4">
                            <div>
                              <label
                                className={`block text-xs font-black mb-2 ${isDark ? "text-white/50" : "text-black/50"}`}
                              >
                                RECIPIENT
                              </label>
                              <input
                          ...
                          <button
                            ...
                            className={`w-full py-3 font-black border-4 ${
                              isDark
                        ...
                        <div className="flex gap-4">
                          <button
                            onClick={simulateDisconnect}
                            className={`flex-1 py-3 font-black border-4 ${isDark ? "border-[#FF3366] text-[#FF3366] hover:bg-[#FF3366] hover:text-white" : "border-[#CC0033] text-[#CC0033] hover:bg-[#CC0033] hover:text-white"} transition-all`}
                          >
                            DISCONNECT
                          </button>
                        </div>
                ...
                {transactions.length > 0 && (
                  <div className={`mt-6 border-4 ${isDark ? "border-white" : "border-black"}`}>
                    <div
                      className={`px-6 py-4 border-b-4 ${isDark ? "border-white bg-white text-black" : "border-black bg-black text-white"}`}
                    >
                      <span className="font-black text-sm">TRANSACTION_LOG.DAT</span>
                    </div>
                      ...
                      {transactions.map((tx) => (
                        <div key={tx.hash} className="p-4 flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="font-black text-sm">SENT {tx.amount} XLM</p>
              ...
              <div>
                <div className={`border-4 ${isDark ? "border-[#39FF14]/30" : "border-[#00AA55]/30"}`}>
                  ...
                  <div className="p-6 space-y-4">
                    {[
                      ...
                      {
                        label: "GAS SAVINGS",
                        value: xrayMetrics.gasSavingsPercent + "%",
                        color: "#FFD600",
                        icon: TrendingUp,
                      },
                      {
                        label: "AVG VERIFY TIME",
                        value: xrayMetrics.avgVerificationMs + "ms",
                        color: "#00FF88",
                        icon: Clock,
                      },
                    ].map((metric) => (
                      <div
                        key={metric.label}
                        className={`flex items-center justify-between py-3 border-b-2 ${isDark ? "border-white/10" : "border-black/10"}`}
                      >
                        <div className="flex items-center gap-3">
                ...
                {/* Session Info */}
                {demoWallet && (
                  <div className={`mt-6 border-4 ${isDark ? "border-white/20" : "border-black/20"}`}>
                    <div
                      className={`px-6 py-4 border-b-4 ${isDark ? "border-white/20" : "border-black/20"}`}
                    >
                      <span className="font-black text-sm">SESSION_INFO.DAT</span>
                    </div>
                    <div className="p-6 space-y-3">
                      <div className="flex justify-between">
                        <span className={`text-xs ${isDark ? "text-white/50" : "text-black/50"}`}>Provider</span>
                        <span className="font-black text-sm">Google</span>
                      </div>
                      <div className="flex justify-between">
                        <span className={`text-xs ${isDark ? "text-white/50" : "text-black/50"}`}>Network</span>
                        <span className="font-black text-sm text-[#00FF88]">Testnet</span>
                      </div>
                      <div className="flex justify-between">
                        <span className={`text-xs ${isDark ? "text-white/50" : "text-black/50"}`}>Proof Type</span>
                        <span className="font-black text-sm">Groth16</span>
                      </div>
                      <div className="flex justify-between">
                        <span className={`text-xs ${isDark ? "text-white/50" : "text-black/50"}`}>Expires</span>
                        <span className="font-black text-sm">
                          {new Date(demoWallet.sessionExpiry).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                {/* Features */}
                <div className={`mt-6 p-6 border-4 ${isDark ? "border-white/20" : "border-black/20"}`}>
                  <p className={`font-black text-xs mb-4 ${isDark ? "text-white/50" : "text-black/50"}`}>
                    SDK FEATURES
                  </p>
      ...
      {/* CTA */}
      <section
        className={`py-16 px-6 lg:px-8 border-t-4 ${isDark ? "border-white/10" : "border-black/10"}`}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link
              href="/dashboard"
              className={`flex items-center gap-3 px-8 py-4 border-4 ${isDark ? "border-white/30 hover:border-white" : "border-black/30 hover:border-black"} font-black transition-all`}
            >
